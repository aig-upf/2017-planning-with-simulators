(define (problem grid_16_16_2_4_16_4)
  ...
  (:init
    ...
    (= (location cat_0) n_5_9)
(= (location cat_1) n_9_14)
(= (location cat_2) n_7_5)
(= (location cat_3) n_4_2)
(= (location cat_4) n_11_14)
(= (location cat_5) n_11_5)
(= (location cat_6) n_1_10)
(= (location cat_7) n_8_7)
(= (location cat_8) n_4_15)
(= (location cat_9) n_11_11)
(= (location cat_10) n_0_11)
(= (location cat_11) n_7_6)
(= (location cat_12) n_12_7)
(= (location cat_13) n_7_6)
(= (location cat_14) n_13_5)
(= (location cat_15) n_11_13)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
