(define (problem grid_8_8_2_10_8_4)
  ...
  (:init
		...
		(edge n_7_7 n_6_7)
		(edge n_7_7 n_7_6)
    (= (location cat_0) n_5_6)
(= (location cat_1) n_7_4)
(= (location cat_2) n_4_0)
(= (location cat_3) n_5_0)
(= (location cat_4) n_1_4)
(= (location cat_5) n_7_2)
(= (location cat_6) n_4_0)
