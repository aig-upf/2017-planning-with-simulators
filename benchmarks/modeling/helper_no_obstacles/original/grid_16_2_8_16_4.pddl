(define (problem grid_16_16_2_8_16_4)
  ...
  (:init
    ...
    (= (location cat_0) n_4_2)
(= (location cat_1) n_10_14)
(= (location cat_2) n_0_8)
(= (location cat_3) n_8_11)
(= (location cat_4) n_8_14)
(= (location cat_5) n_4_2)
(= (location cat_6) n_5_3)
(= (location cat_7) n_1_3)
(= (location cat_8) n_6_10)
(= (location cat_9) n_12_11)
(= (location cat_10) n_14_0)
(= (location cat_11) n_15_15)
(= (location cat_12) n_0_8)
(= (location cat_13) n_6_11)
(= (location cat_14) n_10_6)
(= (location cat_15) n_14_8)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
