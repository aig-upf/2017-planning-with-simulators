(define (problem grid_4_4_2_11_16_4)
...
(= (location cat_2) n_3_2)
(= (location cat_3) n_2_0)
(= (location cat_4) n_0_1)
(= (location cat_5) n_0_1)
(= (location cat_6) n_3_2)
(= (location cat_7) n_1_0)
(= (location cat_8) n_1_3)
(= (location cat_9) n_0_1)
(= (location cat_10) n_3_2)
(= (location cat_11) n_1_3)
(= (location cat_12) n_2_0)
(= (location cat_13) n_2_1)
(= (location cat_14) n_0_1)
(= (location cat_15) n_0_1)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
