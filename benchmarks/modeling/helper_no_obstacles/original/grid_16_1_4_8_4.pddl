(define (problem grid_16_16_1_4_8_4)
  ...
  (:init
    ...
    (= (location cat_0) n_3_15)
(= (location cat_1) n_15_4)
(= (location cat_2) n_11_12)
(= (location cat_3) n_4_8)
(= (location cat_4) n_9_2)
(= (location cat_5) n_7_7)
(= (location cat_6) n_11_9)
(= (location cat_7) n_1_12)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
