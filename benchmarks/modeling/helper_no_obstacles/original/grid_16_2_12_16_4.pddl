(define (problem grid_16_16_2_12_16_4)
  ...
  (:init
    ...
    (= (location cat_0) n_10_13)
(= (location cat_1) n_5_11)
(= (location cat_2) n_12_5)
(= (location cat_3) n_15_14)
(= (location cat_4) n_15_11)
(= (location cat_5) n_15_5)
(= (location cat_6) n_6_14)
(= (location cat_7) n_11_3)
(= (location cat_8) n_9_2)
(= (location cat_9) n_7_4)
(= (location cat_10) n_7_13)
(= (location cat_11) n_4_6)
(= (location cat_12) n_3_6)
(= (location cat_13) n_10_11)
(= (location cat_14) n_13_12)
(= (location cat_15) n_14_1)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
