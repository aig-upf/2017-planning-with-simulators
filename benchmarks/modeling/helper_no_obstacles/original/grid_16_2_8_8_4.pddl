(define (problem grid_16_16_2_8_8_4)
  ...
  (:init
    ...
    (= (location cat_0) n_4_14)
(= (location cat_1) n_11_10)
(= (location cat_2) n_0_10)
(= (location cat_3) n_7_5)
(= (location cat_4) n_12_6)
(= (location cat_5) n_7_5)
(= (location cat_6) n_13_4)
(= (location cat_7) n_11_12)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
