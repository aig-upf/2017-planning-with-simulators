(define (problem grid_8_8_2_11_16_4)
  ...
  (:init
		...
		(edge n_7_7 n_6_7)
		(edge n_7_7 n_7_6)
    (= (location cat_0) n_4_4)
(= (location cat_1) n_0_3)
(= (location cat_2) n_4_0)
(= (location cat_3) n_6_6)
(= (location cat_4) n_1_0)
(= (location cat_5) n_6_0)
(= (location cat_6) n_0_0)
(= (location cat_7) n_1_5)
(= (location cat_8) n_4_1)
(= (location cat_9) n_2_3)
(= (location cat_10) n_6_0)
(= (location cat_11) n_5_3)
(= (location cat_12) n_5_4)
(= (location cat_13) n_2_7)
(= (location cat_14) n_6_2)
