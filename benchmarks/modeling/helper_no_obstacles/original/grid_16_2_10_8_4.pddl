(define (problem grid_16_16_2_10_8_4)
  ...
  (:init
    ...
    (= (location cat_0) n_1_4)
(= (location cat_1) n_11_8)
(= (location cat_2) n_15_0)
(= (location cat_3) n_8_0)
(= (location cat_4) n_9_14)
(= (location cat_5) n_3_0)
(= (location cat_6) n_14_6)
(= (location cat_7) n_7_15)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
