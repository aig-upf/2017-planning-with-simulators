(define (problem grid_16_16_2_5_16_4)
  ...
  (:init
    ...
    (= (location cat_0) n_12_4)
(= (location cat_1) n_9_8)
(= (location cat_2) n_1_15)
(= (location cat_3) n_6_10)
(= (location cat_4) n_15_14)
(= (location cat_5) n_7_11)
(= (location cat_6) n_9_6)
(= (location cat_7) n_7_10)
(= (location cat_8) n_1_4)
(= (location cat_9) n_11_8)
(= (location cat_10) n_15_1)
(= (location cat_11) n_8_0)
(= (location cat_12) n_9_14)
(= (location cat_13) n_3_0)
(= (location cat_14) n_14_6)
(= (location cat_15) n_7_15)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
