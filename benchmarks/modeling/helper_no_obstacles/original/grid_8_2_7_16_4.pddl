(define (problem grid_8_8_2_7_16_4)
  ...
  (:init
		...
		(edge n_7_7 n_6_7)
		(edge n_7_7 n_7_6)
    (= (location cat_0) n_2_3)
(= (location cat_1) n_5_0)
(= (location cat_2) n_3_1)
(= (location cat_3) n_6_1)
(= (location cat_4) n_1_5)
(= (location cat_5) n_5_2)
(= (location cat_6) n_4_5)
(= (location cat_7) n_3_6)
(= (location cat_8) n_2_0)
(= (location cat_9) n_7_1)
(= (location cat_10) n_0_6)
(= (location cat_11) n_3_3)
(= (location cat_12) n_2_5)
(= (location cat_13) n_2_1)
(= (location cat_14) n_5_4)
(= (location cat_15) n_0_3)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
