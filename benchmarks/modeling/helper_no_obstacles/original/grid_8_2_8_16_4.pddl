(define (problem grid_8_8_2_8_16_4)
  ...
  (:init
		...
		(edge n_7_7 n_6_7)
		(edge n_7_7 n_7_6)
    (= (location cat_0) n_4_3)
(= (location cat_1) n_4_4)
(= (location cat_2) n_2_1)
(= (location cat_3) n_2_5)
(= (location cat_4) n_0_4)
(= (location cat_5) n_3_3)
(= (location cat_6) n_6_3)
(= (location cat_7) n_7_1)
(= (location cat_8) n_0_2)
(= (location cat_9) n_3_3)
(= (location cat_10) n_5_2)
(= (location cat_11) n_7_3)
(= (location cat_12) n_5_7)
(= (location cat_13) n_3_4)
