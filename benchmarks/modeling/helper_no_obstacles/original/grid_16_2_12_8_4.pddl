(define (problem grid_16_16_2_12_8_4)
  ...
  (:init
    ...
    (= (location cat_0) n_9_5)
(= (location cat_1) n_10_12)
(= (location cat_2) n_0_9)
(= (location cat_3) n_4_15)
(= (location cat_4) n_1_11)
(= (location cat_5) n_7_8)
(= (location cat_6) n_14_10)
(= (location cat_7) n_3_2)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
