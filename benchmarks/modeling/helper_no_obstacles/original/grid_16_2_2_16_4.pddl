(define (problem grid_16_16_2_2_16_4)
  ...
  (:init
    ...
    (= (location cat_0) n_7_8)
(= (location cat_1) n_14_6)
(= (location cat_2) n_4_6)
(= (location cat_3) n_14_12)
(= (location cat_4) n_12_13)
(= (location cat_5) n_8_2)
(= (location cat_6) n_1_14)
(= (location cat_7) n_1_7)
(= (location cat_8) n_4_0)
(= (location cat_9) n_15_6)
(= (location cat_10) n_11_13)
(= (location cat_11) n_4_9)
(= (location cat_12) n_9_3)
(= (location cat_13) n_7_8)
(= (location cat_14) n_11_10)
(= (location cat_15) n_1_13)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
