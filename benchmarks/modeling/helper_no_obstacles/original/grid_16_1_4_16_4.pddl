(define (problem grid_16_16_1_4_16_4)
  ...
  (:init
    ...
    (= (location cat_0) n_15_5)
(= (location cat_1) n_5_7)
(= (location cat_2) n_9_12)
(= (location cat_3) n_7_3)
(= (location cat_4) n_4_0)
(= (location cat_5) n_11_12)
(= (location cat_6) n_11_3)
(= (location cat_7) n_1_8)
(= (location cat_8) n_8_5)
(= (location cat_9) n_4_13)
(= (location cat_10) n_11_9)
(= (location cat_11) n_0_10)
(= (location cat_12) n_7_4)
(= (location cat_13) n_12_5)
(= (location cat_14) n_7_4)
(= (location cat_15) n_13_3)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
