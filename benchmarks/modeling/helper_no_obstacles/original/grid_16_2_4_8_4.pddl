(define (problem grid_16_16_2_4_8_4)
  ...
  (:init
    ...
    (= (location cat_0) n_4_1)
(= (location cat_1) n_15_6)
(= (location cat_2) n_11_14)
(= (location cat_3) n_4_10)
(= (location cat_4) n_9_4)
(= (location cat_5) n_7_9)
(= (location cat_6) n_11_11)
(= (location cat_7) n_1_14)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
