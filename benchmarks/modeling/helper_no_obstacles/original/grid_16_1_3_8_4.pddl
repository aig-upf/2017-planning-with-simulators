(define (problem grid_16_16_1_3_8_4)
  ...
  (:init
    ...
    (= (location cat_0) n_7_7)
(= (location cat_1) n_14_5)
(= (location cat_2) n_4_5)
(= (location cat_3) n_14_11)
(= (location cat_4) n_12_12)
(= (location cat_5) n_8_1)
(= (location cat_6) n_1_13)
(= (location cat_7) n_1_6)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
