(define (problem grid_16_16_1_2_8_4)
  ...
  (:init
    ...
    (= (location cat_0) n_8_10)
(= (location cat_1) n_5_0)
(= (location cat_2) n_11_0)
(= (location cat_3) n_14_4)
(= (location cat_4) n_10_5)
(= (location cat_5) n_12_1)
(= (location cat_6) n_13_7)
(= (location cat_7) n_9_13)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
