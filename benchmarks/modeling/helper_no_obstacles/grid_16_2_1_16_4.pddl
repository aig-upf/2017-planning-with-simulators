(define (problem grid_16_16_2_1_16_4)
  ...
  (:init
    ...
    (= (location cat_0) n_1_12)
(= (location cat_1) n_10_2)
(= (location cat_2) n_5_4)
(= (location cat_3) n_6_0)
(= (location cat_4) n_2_7)
(= (location cat_5) n_1_10)
(= (location cat_6) n_14_13)
(= (location cat_7) n_11_15)
(= (location cat_8) n_8_11)
(= (location cat_9) n_5_1)
(= (location cat_10) n_11_1)
(= (location cat_11) n_14_5)
(= (location cat_12) n_10_6)
(= (location cat_13) n_12_2)
(= (location cat_14) n_13_8)
(= (location cat_15) n_9_14)
    (= (view_range cat_0) 2)
(= (view_range cat_1) 2)
(= (view_range cat_2) 2)
(= (view_range cat_3) 2)
