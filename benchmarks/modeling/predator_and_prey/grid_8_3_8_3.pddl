(define (problem grid_8_3_8)
  ...
  (:init
	...
	(= (y n_7_7) 7)
        	...
        	(= (location prey_0) n_7_3)
	(= (location prey_1) n_5_6)
	(= (location prey_2) n_0_7)
	(= (location prey_3) n_5_0)
	(= (location prey_4) n_2_2)
	(= (location prey_5) n_3_4)
	(= (location prey_6) n_4_4)
	(= (location prey_7) n_3_3)

        (= (num_preds) 3)
        (= (current_slot) 0)

        (= (location pred_0) n_1_4)
(= (location pred_1) n_6_4)
