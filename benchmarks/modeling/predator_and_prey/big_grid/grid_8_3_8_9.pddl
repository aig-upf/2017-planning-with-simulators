(define (problem grid_8_3_8)
  ...
  (:init
	...
	(= (y n_7_7) 7)
        	...
        	(= (location prey_0) n_7_2)
	(= (location prey_1) n_1_7)
	(= (location prey_2) n_6_7)
	(= (location prey_3) n_0_5)
	(= (location prey_4) n_3_2)
	(= (location prey_5) n_2_4)
	(= (location prey_6) n_2_0)
	(= (location prey_7) n_5_3)

        (= (num_preds) 3)
        (= (current_slot) 0)

        (= (location pred_0) n_0_2)
(= (location pred_1) n_4_7)
(= (location pred_2) n_5_0)
        	(= (slot pred_0) 0)
	(= (slot pred_1) 1)
	(= (slot pred_2) 2)
