(define (problem grid_8_2_8)
  ...
  (:init
	...
	(= (y n_7_7) 7)
        	...
        	(= (location prey_0) n_0_7)
	(= (location prey_1) n_7_5)
	(= (location prey_2) n_1_5)
	(= (location prey_3) n_4_1)
	(= (location prey_4) n_4_5)
	(= (location prey_5) n_5_3)
	(= (location prey_6) n_0_2)
	(= (location prey_7) n_2_3)

        (= (num_preds) 2)
        (= (current_slot) 0)

        (= (location pred_0) n_1_0)
(= (location pred_1) n_4_3)
        	(= (slot pred_0) 0)
	(= (slot pred_1) 1)
