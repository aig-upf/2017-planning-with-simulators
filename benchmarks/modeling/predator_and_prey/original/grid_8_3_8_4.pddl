(define (problem grid_8_3_8)
  ...
  (:init
	...
	(= (y n_7_7) 7)
        	...
        	(= (location prey_0) n_1_6)
	(= (location prey_1) n_6_3)
	(= (location prey_2) n_6_5)
	(= (location prey_3) n_5_1)
	(= (location prey_4) n_5_3)
	(= (location prey_5) n_5_4)
	(= (location prey_6) n_6_4)
	(= (location prey_7) n_2_5)

        (= (num_preds) 3)
        (= (current_slot) 0)

        (= (location pred_0) n_5_2)
(= (location pred_1) n_3_6)
