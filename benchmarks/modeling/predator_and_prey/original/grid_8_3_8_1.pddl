(define (problem grid_8_3_8)
  ...
  (:init
	...
	(= (location prey_1) n_5_0)
	(= (location prey_2) n_2_4)
	(= (location prey_3) n_2_7)
	(= (location prey_4) n_1_1)
	(= (location prey_5) n_0_6)
	(= (location prey_6) n_5_7)
	(= (location prey_7) n_4_2)

        (= (num_preds) 3)
        (= (current_slot) 0)

        (= (location pred_0) n_3_0)
(= (location pred_1) n_6_3)
(= (location pred_2) n_6_1)
        	(= (slot pred_0) 0)
	(= (slot pred_1) 1)
	(= (slot pred_2) 2)
