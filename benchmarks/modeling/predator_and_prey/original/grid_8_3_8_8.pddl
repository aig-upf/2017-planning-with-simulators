(define (problem grid_8_3_8)
  ...
  (:init
	...
	(= (location prey_1) n_3_6)
	(= (location prey_2) n_7_2)
	(= (location prey_3) n_1_4)
	(= (location prey_4) n_0_4)
	(= (location prey_5) n_2_2)
	(= (location prey_6) n_4_7)
	(= (location prey_7) n_3_0)

        (= (num_preds) 3)
        (= (current_slot) 0)

        (= (location pred_0) n_6_7)
(= (location pred_1) n_1_7)
(= (location pred_2) n_6_0)
        	(= (slot pred_0) 0)
	(= (slot pred_1) 1)
	(= (slot pred_2) 2)
